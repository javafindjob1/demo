      ...
      for (int i = 0; i < list.size(); i++) {
        ...
        try {
          if (ability.getName().contains("旅行者简介")) {
            ...
            if (list2 != null) {
              AbilityDetail abilityDetail2 = list2.get(i);
              insertDescription(row, 4, cellStyle, workbook, "增强");
              insertDescription(row, 5, cellStyle, workbook, abilityDetail2.getUbertip());
            } else {
