...
public class ClientForCalc {
    ...
    public static void parseID(Map<String, ItemDetail> nameItemMap) throws Exception {
        BufferedReader br = new BufferedReader(new InputStreamReader(Files.newInputStream(Paths.get("D:\\Code\\demo\\demo\\src\\main\\java\\com\\xi3\\custom\\test")), "utf8"));
        try (BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(Files.newOutputStream(Paths.get("D:\\Code\\demo\\demo\\src\\main\\java\\com\\xi3\\custom\\testout")), "utf8"))) {
