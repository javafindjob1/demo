...
import com.dj.parse.DestructableDetail;
import com.dj.parse.DestructableParse;
import com.dj.parse.ExcelImageInsert;
import com.dj.parse.HeroParse;
import com.dj.parse.HeroSheet;
import com.dj.parse.ItemDetail;
import com.dj.parse.ItemParse;
import com.dj.parse.ItemSheet;
import com.dj.parse.UnitDetail;
import com.dj.parse.UnitParse;
import com.dj.parse.UnitSheet;
import com.dj.sqlite.SqLiteJDBC;

public class Client {
  public static void main(String[] args) throws Exception {

    String excelName = "刀剑物语装备介绍_v1.83.xlsx";
    SqLiteJDBC.setVersion("v1.83", "v1.83");
    ...
    itemSheet.insert("传送", itemParse.getDropUnit("传送"));
    ...
    // 打印不存在的资源
    for(String asset: ExcelImageInsert.notfoundList){
