...
public class ImageUtils
{
	...
	/**
	 * Takes an images as input and generates an array containing this image and all possible mipmaps
	 *
	 * @param input
	 * @return
	 */
	...
	/**
	 * An alternative way to convert an image to type_byte_indexed (paletted) that avoids dithering.
	 *
	 * @param src
	 * @return
	 */
