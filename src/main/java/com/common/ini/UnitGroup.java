...
public class UnitGroup {
  ...
  public UnitGroup(Map<String, Map<String, String>> iniMap) {
    ...
    Map<String, String> ultis = iniMap.get("heros");
    for (Entry<String, String> entry : ultis.entrySet()) {
      ...
      this.heros.put(heroId, ulti.toArray(new String[] {}));
    }
  ...
  public String getBaseHeroId(String id) {
    return this.baseHeros.get(id);
  }

  public String getIntro(String id) {
    String baseHeroId = getBaseHeroId(id);
