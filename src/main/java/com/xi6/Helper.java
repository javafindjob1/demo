...
public class Helper {
  ...
  public static void main(String[] args) throws Exception {
    ...
    UnitDetail u = idUnitMap.get("O018");
    u.setName("武装牛头");
  ...
  public static void handleJ(List<Function> funList, Map<String, UnitDetail> idUnitMap,
    ...
    try (
        BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(
            new FileOutputStream("D:\\Code\\demo\\demo\\src\\main\\java\\com\\xi6\\custom\\hero0.ini"), "utf8"))) {
  ...
  private static Pattern ultiPat = Pattern.compile(
      "GetUnitTypeId\\(GetTriggerUnit\\(\\)\\)=='(\\w{4})'( or GetUnitTypeId\\(GetTriggerUnit\\(\\)\\)=='(\\w{4})')? and GetUnitLevel\\(GetTriggerUnit\\(\\)\\)>=15 and GetUnitAbilityLevel\\(GetTriggerUnit\\(\\),'(\\w{4})'\\)==0 ");
