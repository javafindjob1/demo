...
public class Client {
  public static void main(String[] args) throws Exception {
    ...
    itemSheet.insert("美食", itemParse.getDropUnit("美食"));
