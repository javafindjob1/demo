...
import com.xi6.parse.AbilityDetail;
import com.xi6.parse.AbilityParse;
import com.xi6.parse.DestructableDetail;
import com.xi6.parse.DestructableParse;
import com.xi6.parse.ExcelImageInsert;
import com.xi6.parse.ItemDetail;
import com.xi6.parse.ItemParse;
import com.xi6.parse.UnitDetail;
import com.xi6.parse.UnitParse;
import com.xi6.sqlite.SqLiteJDBC;

public class ClientForCalc {
    public static void main(String[] args) throws Exception {

        String excelName = "西方世界的劫难6装备介绍_v2.4.5.xlsx";
        SqLiteJDBC.setVersion("v2.4.5", "v2.4.5");

        String w3xliniPath = "D:\\war5-jass\\jass_plugin\\w3x2lni_zhCN_v2.5.2\\w3x2lni_zhCN_v2.5.2\\";
        String assetPath = w3xliniPath + "0x6\\C8298541410AF40FA5B42B0CD675800D\\";
    ...
    public static void parseID(Map<String, ItemDetail> nameItemMap) throws Exception {
        BufferedReader br = new BufferedReader(new InputStreamReader(Files.newInputStream(Paths.get("D:\\Code\\demo\\demo\\src\\main\\java\\com\\xi6\\custom\\test")), "utf8"));
        try (BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(Files.newOutputStream(Paths.get("D:\\Code\\demo\\demo\\src\\main\\java\\com\\xi6\\custom\\testout")), "utf8"))) {
