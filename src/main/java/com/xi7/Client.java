...
import com.xi7.sqlite.SqLiteJDBC;
...
public class Client {
  public static void main(String[] args) throws Exception {
    ...
    String excelName = "西7装备介绍_v2.2.5.xlsx";
    SqLiteJDBC.setVersion("v2.2.5", "v2.1.6");
    String w3xliniPath = "D:\\war5-jass\\jass_plugin\\w3x2lni_zhCN_v2.5.2\\w3x2lni_zhCN_v2.5.2\\";
    String assetPath = w3xliniPath + "0x7\\125A6F83569B3CBF1944579694EF2F6E\\";
